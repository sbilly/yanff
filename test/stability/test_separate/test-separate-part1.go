...
func main() {
	...
	println("On port", RECV_PORT1, "received=", recv1, "pkts")
	println("On port", RECV_PORT2, "received=", recv2, "pkts")

	println("Proportion of packets received on", RECV_PORT1, "port =", p1, "%")
	println("Proportion of packets received on", RECV_PORT2, "port =", p2, "%")
